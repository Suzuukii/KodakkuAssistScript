...
namespace SuzuukiiKodakkuAssist
{
    ...
    public class Dancing_Mad_Ultimate
    {
        ...
        */
        ...
        private const string PHASE2_TRANSITION_SOURCE_DATA_ID="19506";
        private const int PHASE2_TERMINAL_DUAL_ARMS_RADIUS=5;
        private const int PHASE2_TERMINAL_DUAL_ARMS_DURATION=5000;
        ...
        public void P2_阶段控制(Event @event,ScriptAccessory accessory) {
            ...
            if(!string.Equals(@event["SourceDataId"],PHASE2_TRANSITION_SOURCE_DATA_ID)) {
            ...
            debugLog(accessory,$"P2 阶段控制: majorPhase={majorPhase}, phase={phase}。");
        ...
        public void P2_终末双腕_范围(Event @event,ScriptAccessory accessory) {
            ...
            drawCircleOnObject(accessory,
                targetId,
                PHASE2_TERMINAL_DUAL_ARMS_RADIUS,
                colourOfExtremelyDangerousAttacks.V4.WithW(1),
                PHASE2_TERMINAL_DUAL_ARMS_DURATION,
                $"P2_终末双腕_范围_{targetId:X}");
